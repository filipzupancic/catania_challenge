...
class ApiClient(object):
    ...
    def __init__(self, host=None, header_name=None, header_value=None, cookie=None, pools_size=5, maxsize=8):
        """
        Constructor of the class.
        """
        self.rest_client = RESTClientObject(pools_size=pools_size, maxsize=maxsize)
    ...
    def __deserialize_model(self, data, klass):
        ...
        if "$type" in data:
            try:
                klass = getattr(models, data.get("$type"))
